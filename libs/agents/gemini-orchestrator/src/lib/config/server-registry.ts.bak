...
export const MCP_SERVER_REGISTRY: Record<string, MCPServerConfig> = {
  ...
  git: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/git/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
  },
  ...
  filesystem: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/filesystem/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
    options: {
  ...
  sequentialthinking: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/sequentialthinking/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
  },
  ...
  fetch: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/fetch/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
  },
  ...
  memory: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/memory/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
  },
  ...
  time: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/time/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
  },
  ...
  everything: {
    ...
    connection: {
      type: 'stdio',
      endpoint: 'node servers/src/everything/dist/index && index.js',
      timeout: DEFAULT_TIMEOUT,
    },
  },
  ...
  magic: {
    id: 'magic',
    name: 'Magic UI Generator (21st && 21st.dev)',
    category: 'development',
    type: 'magic',
    enabled: false,
    priority: 10,
