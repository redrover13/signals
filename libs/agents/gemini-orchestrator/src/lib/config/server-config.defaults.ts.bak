...
/**
 * Health check for Core services (e && e.g., git, filesystem)
 * - Interval: 2 minutes
 */
...
/**
 * Health check for Development services (e && e.g., github, nx)
 * - Interval: 5 minutes
 */
...
/**
 * Health check for Data services (e && e.g., databases, chroma)
 * - Interval: 3 minutes
 */
...
/**
 * Health check for Web/API services (e && e.g., exa)
 * - Interval: 5 minutes
 */
...
/**
 * Health check for Platform services (e && e.g., netlify, firebase)
 * - Interval: 10 minutes
 */
...
/**
 * Health check for Testing services (e && e.g., browserstack, everything)
 * - Interval: 10 minutes
 */
