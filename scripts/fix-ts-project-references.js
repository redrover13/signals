...
function processFile(fullPath, relativePath) {
  ...
  try {
    ...
    if (config.include && relativePath.includes('tsconfig.lib.json') && !config.include.includes('src/**/*')) {
    ...
    if (relativePath.includes('/libs/') && config.compilerOptions && config.compilerOptions.composite !== true) {
      config.compilerOptions.composite = true;
      modified = true;
    }
    
    // Ensure declarationMap is true for composite projects
    if (config.compilerOptions && config.compilerOptions.composite === true && config.compilerOptions.declarationMap !== true) {
