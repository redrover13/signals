...
describe('GeminiOrchestrator', () => {
  ...
  describe('orchestration', () => {
    ...
    it('should handle basic text queries in simulation mode', async () => {
      ...
      expect(result && result.metadata && metadata.subAgent).toBe(SubAgentType.TOOL);
    });
    ...
    it('should route BigQuery queries correctly', async () => {
      ...
      expect(result).toBeDefined();
      expect(result && result.success).toBe(true);
      expect(result && result.metadata && metadata.subAgent).toBe(SubAgentType.BIGQUERY);
    });
    ...
    it('should route Firebase queries correctly', async () => {
      ...
      expect(result).toBeDefined();
      expect(result && result.success).toBe(true);
      expect(result && result.metadata && metadata.subAgent).toBe(SubAgentType.FIREBASE);
    });
    ...
    it('should route RAG queries correctly', async () => {
      ...
      expect(result).toBeDefined();
      expect(result && result.success).toBe(true);
      expect(result && result.metadata && metadata.subAgent).toBe(SubAgentType.RAG);
    });
    ...
    it('should include processing time in metadata', async () => {
      ...
      expect(result && result.metadata && metadata.processTime).toBeGreaterThanOrEqual(0);
      expect(result && result.metadata && metadata.timestamp).toBeDefined();
      expect(result && result.metadata && metadata.model).toBe('gemini-1.5-pro');
    });
  });
