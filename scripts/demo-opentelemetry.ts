...
async function demoBasicInstrumentation() {
  ...
  console.log('✅ Manual span result:', result1);
  ...
  console.log('✅ Instrumented function result:', result2);
...
async function demoBigQueryLogging() {
  ...
  console.log('✅ BigQuery logger created (not initialized for demo)');
...
async function demoDashboardTemplates() {
  ...
  console.log('📊 Total charts:', template.pages.reduce((sum: number, page: any) => sum + page.charts.length, 0));
  ...
  console.log('📝 Query excerpt:', queryExcerpt);
}
...
async function demoErrorHandlingAndCompliance() {
  console.log('\n🛡️  Demo: Error Handling and Compliance');
