...
class TestIsPinnedAction:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("owner/repo@1234567", True),              # any non-empty ref not in {main, master, latest} -> pinned per implementation
            ("owner/repo@feature-branch", True),       # branch treated as pinned by current function logic
