...
#### undefined: 2 projects missing test configuration
...
### Add Missing Test Configurations (2 projects) (high)
...
**Affected Projects:** agents-lib, gcp
...
### Add Missing Test Configurations (2 projects)

- **Script:** `nx-diagnostics/scripts/fixes/add-test-configs.sh`
- **Priority:** high
- **Affected:** agents-lib, gcp
