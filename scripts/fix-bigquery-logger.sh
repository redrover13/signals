...
# Script to fix bigquery-logger.ts
echo "🔧 Fixing BigQuery Logger..."

# Create a directory if it doesn't exist
mkdir -p ./libs/utils/monitoring/src/lib

# Create the fixed file
cat > ./libs/utils/monitoring/src/lib/bigquery-logger.ts.new << 'EOF2'
/**
...
# Replace the file
mv ./libs/utils/monitoring/src/lib/bigquery-logger.ts.new ./libs/utils/monitoring/src/lib/bigquery-logger.ts

echo "✅ BigQuery Logger fixed!"
