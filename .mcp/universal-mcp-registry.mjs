...
Usage:
  node universal-mcp-registry.mjs deploy     - Deploy MCP config to all AI platforms
  node universal-mcp-registry.mjs verify     - Verify platform access to MCP servers
  node universal-mcp-registry.mjs integrate  - Create platform integration scripts
  node universal-mcp-registry.mjs report     - Generate compatibility report
...
export default UniversalMCPRegistry;
