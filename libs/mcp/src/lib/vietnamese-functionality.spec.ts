  ...
  describe('Character Encoding', () => {
    ...
    it('should handle Vietnamese diacritical marks correctly', () => {
      const testCases = [
        ...
        'ẳ',
        'ẵ',
        'ặ', // a with breve and diacritics
        'â',
        'ấ',
        'ầ',
        'ẩ',
        'ẫ',
        'ậ', // a with circumflex and diacritics
        'đ', // d with stroke
        'é',
        'è',
        'ẻ',
        ...
        'ể',
        'ễ',
        'ệ', // e with circumflex and diacritics
        'í',
        'ì',
        'ỉ',
        'ĩ',
        ...
        'ổ',
        'ỗ',
        'ộ', // o with circumflex and diacritics
        'ơ',
        'ớ',
        'ờ',
        'ở',
        'ỡ',
        'ợ', // o with horn and diacritics
        'ú',
        'ù',
        'ủ',
        'ũ',
  ...
  describe('Text Processing', () => {
    ...
    it('should handle Vietnamese search terms correctly', () => {
      ...
      const search = (term: string | undefined, docs: string[]): string[] => {
        return (
          docs &&
          docs.filter((doc) => doc && doc.toLowerCase().includes(term && term.toLowerCase()))
        );
      };
