...
# Script to fix server-health.service.ts
echo "🔧 Fixing Server Health Service..."

# Create a directory if it doesn't exist
mkdir -p ./libs/utils/api-clients/src/lib

# Create the fixed file
cat > ./libs/utils/api-clients/src/lib/server-health.service.ts.new << 'EOF2'
/**
...
# Replace the file
mv ./libs/utils/api-clients/src/lib/server-health.service.ts.new ./libs/utils/api-clients/src/lib/server-health.service.ts

echo "✅ Server Health Service fixed!"
